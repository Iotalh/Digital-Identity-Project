...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="userDataWithUI.php">資訊管理系統</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="userIndexWithUI.php">合約列表</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="userDataWithUI.php">個人資訊</a>
                    </li>
                </ul>
