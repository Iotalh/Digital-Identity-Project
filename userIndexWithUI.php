        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" href="contractList.html">合約列表</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="userInfo.html">個人資訊</a>
                    </li>
                </ul>
        ...
        <ul class="list-group">
            ...
            for ($i = 0; $i < $cnt; $i++) {
                ...
                <div class="row">
                    <div class="col-10 d-flex justify-content-evenly align-items-center">
                        ...
                        <span class="badge rounded-pill bg-success">第一級</span>
                        <p class="h6 mb-0">簽約公司名稱</p>
                        <h3 class="h6 mb-0">合約到期日</h3>
                        <p class="h6 mb-0">2022/01/01</p>
                    ...
                    <div class="col-2 d-flex justify-content-around">
                        ...
                        <form action="detail.php" method="post">
                            <button type="button" name="pri_id" value=' . $i . ' class="btn btn-outline-primary btn-sm fw-bold px-2" data-bs-toggle="collapse" data-bs-target="#contract' . $i . '" aria-expanded="false" aria-controls="contract1">
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-2 d-flex justify-content-around">
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#stop2">終止合約</button>
                        <button type="button" class="btn btn-outline-primary btn-sm fw-bold px-2" data-bs-toggle="collapse" data-bs-target="#contract2" aria-expanded="false" aria-controls="contract2">
                            <span class="material-icons align-middle">expand_more</span>
                        </button>
                    </div>
                </div>

                <div class="collapse" id="contract2">
                    <h3 class="h5 mt-3">合約簡介</h3>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique libero deleniti iste
                        nulla blanditiis nihil iusto quo corrupti accusamus quam.</p>
                </div>
